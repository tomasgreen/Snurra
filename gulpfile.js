...
gulp.task('watch', function () {
	...
	gulp.watch('./src/example/img/**/*', ['example-img']);
...
gulp.task('example-img', function () {
	gulp.src('./src/example/img/**/*')
		.pipe(gulp.dest('./example/static/'));
});
...
var run = ['plugin-less', 'plugin-js', 'example-less', 'example-js', 'example-html', 'watch', 'webserver','example-img'];
