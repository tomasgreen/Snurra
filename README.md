...
Apparently this library does not work with IE, at all. Something to do with adding classes to SVG's or even animating SVG's. This is new to me, don't really know how that happend but it's not someting I'll fix. So any IE fan will have to wait for EDGE or use ladda (it it works?).
---
